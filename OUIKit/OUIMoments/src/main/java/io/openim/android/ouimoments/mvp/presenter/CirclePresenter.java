...
public class CirclePresenter implements CircleContract.Presenter {
    ...
    private final NotificationVM notificationVM;
    ...
    public CirclePresenter(CircleContract.View view) {
        ...
        notificationVM.momentsUnread.observe((LifecycleOwner) view, v -> {
            if (v > 0) {
                unReadCount = String.valueOf(v);
    ...
    public void getWorkMomentsUnReadCount() {
        notificationVM.getWorkMomentsUnReadCount();
    }
