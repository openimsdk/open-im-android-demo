package io.openim.android.ouimoments.utils;
...
public class DatasUtil {
    public static final String[] CONTENTS = {"", "哈哈，18123456789,ChinaAr  http://www.ChinaAr.com;"
        + "一个不错的VR网站。哈哈，ChinaAr  http://www.ChinaAr" + ".com;一个不错的VR网站。哈哈，ChinaAr  http://www" +
        ".ChinaAr.com;一个不错的VR网站。哈哈，ChinaAr  http://www" + ".ChinaAr.com;一个不错的VR网站。",
        ...
        "VR（Virtual Reality，即虚拟现实，简称VR），是由美国VPL公司创建人拉尼尔（Jaron " + "Lanier）在20世纪80" +
            "年代初提出的。其具体内涵是：综合利用计算机图形系统和各种现实及控制等接口设备，在计算机上生成的、可交互的三维环境中提供沉浸感觉的技术。其中，计算机生成的、可交互的三维环境称为虚拟环境（即Virtual Environment，简称VE）。虚拟现实技术是一种可以创建和体验虚拟世界的计算机仿真系统的技术。它利用计算机生成一种模拟环境，利用多源信息融合的交互式三维动态视景和实体行为的系统仿真使用户沉浸到该环境中。",
        //"哈哈哈哈",
        //"图不错",
        "我勒个去"};
    /*public static final String[] PHOTOS = {
            "http://f.hiphotos.baidu.com/image/pic/item/faf2b2119313b07e97f760d908d7912396dd8c9c
            .jpg",
            "http://g.hiphotos.baidu.com/image/pic/item/4b90f603738da977c76ab6fab451f8198718e39e
            .jpg",
            "http://e.hiphotos.baidu.com/image/pic/item/902397dda144ad343de8b756d4a20cf430ad858f
            .jpg",
            "http://a.hiphotos.baidu.com/image/pic/item/a6efce1b9d16fdfa0fbc1ebfb68f8c5495ee7b8b
            .jpg",
            "http://b.hiphotos.baidu.com/image/pic/item/a71ea8d3fd1f4134e61e0f90211f95cad1c85e36
            .jpg",
            "http://c.hiphotos.baidu.com/image/pic/item/7dd98d1001e939011b9c86d07fec54e737d19645
            .jpg",
            "http://f.hiphotos.baidu.com/image/pic/item/f11f3a292df5e0fecc3e83ef586034a85edf723d
            .jpg",
    ...
    public static final String[] HEADIMG = {"http://img.wzfzl" + ".cn/uploads/allimg/140820" +
        "/co140R00Q925-14.jpg",
        "http://www.feizl" + ".com/upload2007/2014_06/1406272351394618" + ".png", "http://v1" +
        ".qzone" + ".cc/avatar/201308/30/22/56/5220b2828a477072.jpg%21200x200" + ".jpg", "http" +
        "://v1.qzone" + ".cc/avatar/201308/22/10/36/521579394f4bb419.jpg!200x200.jpg", "http://v1" +
        ".qzone" + ".cc/avatar/201408/20/17/23/53f468ff9c337550.jpg!200x200.jpg", "http://cdn" +
        ".duitang" + ".com/uploads/item/201408/13/20140813122725_8h8Yu.jpeg", "http" + "://img" +
        ".woyaogexing" + ".com/touxiang/nv/20140212/9ac2117139f1ecd8%21200x200.jpg", "http" +
        "://p1.qqyou" + ".com/touxiang/uploadpic/2013-3/12/2013031212295986807.jpg"};
    ...
    static {
        ...
        p1.url = "http://f.hiphotos.baidu" + ".com/image/pic/item" +
            "/faf2b2119313b07e97f760d908d7912396dd8c9c.jpg";
        p1.w = 640;
        p1.h = 792;

        PhotoInfo p2 = new PhotoInfo();
        p2.url = "http://g.hiphotos.baidu" + ".com/image/pic/item" +
            "/4b90f603738da977c76ab6fab451f8198718e39e.jpg";
        p2.w = 640;
        p2.h = 792;

        PhotoInfo p3 = new PhotoInfo();
        p3.url = "http://e.hiphotos.baidu" + ".com/image/pic/item" +
            "/902397dda144ad343de8b756d4a20cf430ad858f.jpg";
        p3.w = 950;
        p3.h = 597;

        PhotoInfo p4 = new PhotoInfo();
        p4.url = "http://a.hiphotos.baidu" + ".com/image/pic/item" +
            "/a6efce1b9d16fdfa0fbc1ebfb68f8c5495ee7b8b.jpg";
        p4.w = 533;
        p4.h = 800;

        PhotoInfo p5 = new PhotoInfo();
        p5.url = "http://b.hiphotos.baidu" + ".com/image/pic/item" +
            "/a71ea8d3fd1f4134e61e0f90211f95cad1c85e36.jpg";
        p5.w = 700;
        p5.h = 467;

        PhotoInfo p6 = new PhotoInfo();
        p6.url = "http://c.hiphotos.baidu" + ".com/image/pic/item" +
            "/7dd98d1001e939011b9c86d07fec54e737d19645.jpg";
        p6.w = 700;
        p6.h = 467;

        PhotoInfo p7 = new PhotoInfo();
        p7.url = "http://c.hiphotos.baidu" + ".com/image/pic/item" +
            "/7dd98d1001e939011b9c86d07fec54e737d19645.jpg";
        p7.w = 1024;
        p7.h = 640;

        PhotoInfo p8 = new PhotoInfo();
        p8.url = "http://c.hiphotos.baidu" + ".com/image/pic/item" +
            "/7dd98d1001e939011b9c86d07fec54e737d19645.jpg";
        p8.w = 1024;
        p8.h = 768;

        PhotoInfo p9 = new PhotoInfo();
        p9.url = "http://c.hiphotos.baidu" + ".com/image/pic/item" +
            "/7dd98d1001e939011b9c86d07fec54e737d19645.jpg";
        p9.w = 1024;
        p9.h = 640;

        PhotoInfo p10 = new PhotoInfo();
        p10.url = "http://c.hiphotos.baidu" + ".com/image/pic/item" +
            "/7dd98d1001e939011b9c86d07fec54e737d19645.jpg";
        p10.w = 1024;
        p10.h = 768;
    ...
    public static List<CircleItem> createCircleDatas() {
        ...
        for (int i = 0; i < 15; i++) {
            ...
            if (type == 0) {
                ...
                item.setType("3");// 视频
                String videoUrl =
                    "http://yiwcicledemo.s.qupai" + ".me/v/80c81c19-7c02-4dee-baca" +
                        "-c97d9bbd6607.mp4";
                String videoImgUrl =
                    "http://yiwcicledemo.s.qupai" + ".me/v/80c81c19-7c02-4dee" + "-baca" +
                        "-c97d9bbd6607.jpg";
