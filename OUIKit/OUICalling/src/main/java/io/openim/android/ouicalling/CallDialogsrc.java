...
import io.openim.android.ouicalling.databinding.DialogCallSrcBinding;
...
public class CallDialogsrc extends BaseDialog {

    protected final HasPermissions hasShoot, hasRecord, hasSystemAlert;
    protected Context context;
    private DialogCallSrcBinding view;
    ...
    public CallDialogsrc(@NonNull Context context, CallingService callingService) {
     ...
     */
    public CallDialogsrc(@NonNull Context context, CallingService callingService, boolean isCallOut) {
        super(context);
    ...
    private void initView() {
        ...
        view = DialogCallSrcBinding.inflate(getLayoutInflater());
