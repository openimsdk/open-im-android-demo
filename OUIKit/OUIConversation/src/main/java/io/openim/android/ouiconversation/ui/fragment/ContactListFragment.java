...
public class ContactListFragment extends BaseFragment<ContactListVM> implements ContactListVM.ViewAction, Observer {
    ...
    private void init() {
        ...
        SwipeMenuCreator mSwipeMenuCreator = (leftMenu, rightMenu, position) -> {
            ...
            delete.setBackgroundColor(getResources().getColor(io.openim.android.ouicore.R.color.txt_warning));
            ...
            top.setBackgroundColor(getResources().getColor(io.openim.android.ouicore.R.color.theme));
            ...
            martRead.setBackgroundColor(getResources().getColor(io.openim.android.ouicore.R.color.txt_shallow));
...
//        (android.R.color.transparent), 1, 36));
    ...
    private void showPopupWindow(View v) {
        ...
        view.createGroup.setOnClickListener(c -> {
            popupWindow.dismiss();
            ARouter.getInstance().build(Routes.Group.CREATE_GROUP3).withBoolean(Constant.K_RESULT,
                true).navigation();
        });
